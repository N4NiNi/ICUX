...
<html lang="en">
  <head>
    ...
    <title>EUXT | Exploring User eXperience Tools</title>
  ...
  <body>
    ...
    <div ">
        <main id="teste">
            <section class="d-flex align-items-center justify-content-center" id="home">
                <iframe width="800" height="450" src="https://www.youtube.com/embed/G-C0Gqu9Ybw" title="Ferramentas computacionais voltadas ao usuário são tema de pesquisa na UFSCar" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" class="rounded-md"></iframe>
            </section>
            
            <section class="d-flex justify-content-center" id="uxtoolkit">
            ...
            <section class="d-flex align-items-center justify-content-center" id="about">
